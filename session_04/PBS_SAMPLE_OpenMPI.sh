...
### #PBS -e /home/ssingh/HPL_RUNS/<ERROR FILE NAME>
### #PBS -o /home/ssingh/HPL_RUNS/<OUTPUT FILE NAME>
...
#MPIRUN=`which mpirun`
#${MPIRUN}  --mca btl ^tcp -machinefile $PBS_NODEFILE -np ${NPROCS} <YOUR PROGRAM EXECUTABLE GOES HERE WITH ALL OPTIONS>
